        ...
        <Tab.Navigator
            screenOptions={({ route }) => ({
                ...
                tabBarIcon: ({ focused, color, size }) => {
                    ...
                    else if (route.name === 'BookedScreen') iconName = focused ? 'check-square' : 'check-square';
                    else if (route.name === 'Login') iconNameHuh = focused ? 'ööh?' : 'ööh?';
                    else if (route.name === 'Booking') return null;
                    else if (route.name === 'LoadingScreen') iconNameHuh = focused ? 'ööh?' : 'ööh?';
                    else if (route.name === 'Rooms') iconName = focused ? 'map' : 'map';
                    else if (route.name === 'Contact') iconName = focused ? 'envelope' : 'envelope';
